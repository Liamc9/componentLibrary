...
const LoginPage = () => {
  ...
  return (
    <div className="mt-8 flex min-h-screen items-center justify-center bg-gray-100 px-2">
      <div className="w-full max-w-md rounded-lg bg-white p-6 px-4 shadow-md sm:px-6 lg:px-8">
        ...
        <form className="mt-4 space-y-4" onSubmit={handleLogin}>
          ...
          <div>
            <button
              type="submit"
              className="group relative flex w-full justify-center rounded-md border border-transparent bg-purple-600 px-4 py-2 text-sm font-medium text-white hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 sm:text-base"
              disabled={isLoading}
            >
